...
public class StateMachine 
{
    ...
    {     
        ...
        IntakingState intakingState = new IntakingState(pSwerveDrive, pIntake, pShooter, pControls);
        mStates.put(intakingState.GetState(), intakingState);

        HoldingState holdingState = new HoldingState(pSwerveDrive, pIntake, pShooter, pControls);
        mStates.put(holdingState.GetState(), holdingState);

        ShootingState shootingState = new ShootingState(pSwerveDrive, pIntake, pShooter, pControls);
